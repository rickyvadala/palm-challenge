...
import {deposit} from "../../../store/slices/fiat";
...
export const CryptoWalletTransaction: React.FC<CryptoWalletTransactionType> = ({isModalVisible, handleOk, handleCancel}) => {
    ...
    return (
        <Modal className="fiat-transaction"
            ...
            >
                ...
                >
                    <Input type={"number"} size="large" prefix="KovanETH"/>
                </Form.Item>
